...
public class MapAnimator {
    ...
    static final int GREY = Color.parseColor("#9e8bf3");
    static final int GREEN = Color.parseColor("#7b6cc1");
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute, Polyline lines) {
        ...
        optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(GREEN).width((int) context.getResources().getDimension(R.dimen.poliline_width));
...
//        }
        ...
        ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), GREY, GREEN);
